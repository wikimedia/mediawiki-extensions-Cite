...
ve.dm.MWReferencesListNode.static.toDomElements = function ( data, doc, converter ) {
	...
	const mwData = ve.dm.MWReferencesListNode.static.mwDataForDom( attributes, originalMwData );
 ...
 * @param {Object} originalMwData
 * @return {Object}
 * */
ve.dm.MWReferencesListNode.static.mwDataForDom = function ( attributes, originalMwData ) {
