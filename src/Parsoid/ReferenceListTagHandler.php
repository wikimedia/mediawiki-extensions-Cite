...
class ReferenceListTagHandler extends ExtensionTagHandler {
	...
	public function sourceToDom(
		...
		$status = Validator::filterReferenceListArguments( null, $extApi->extArgsToArray( $extArgs ) );
	...
	public function domToWikitext(
		...
		$html = isset( $dataMw->body ) && $dataMw->body->hasHtml() ? $dataMw->body->getHtml( $extApi ) : null;
		$src = $html ? $extApi->domToWikitext( [ 'extName' => $dataMw->name ], $html ) : '';
