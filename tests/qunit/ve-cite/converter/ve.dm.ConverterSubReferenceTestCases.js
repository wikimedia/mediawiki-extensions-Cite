...
ve.dm.ConverterSubReferenceTestCases.cases[ 'Two main refs with content ( convert both to sub-refs one at a time )' ] = {
	...
	modify:
		( model ) => {
			...
			model.commit( ve.dm.Transaction.static.deserialize( [ 3, [ '', [ { type: 'mwReference', attributes: { mainRefKey: 'literal/book', mainListKey: 0, listGroup: 'mwReference/', listKey: 'auto/0', listIndex: 1, refGroup: '', contentsUsed: true }, originalDomElementsHash: 0.3497685742494072 }, { type: '/mwReference' } ] ], 29 ] ) );
			...
			model.commit( ve.dm.Transaction.static.deserialize( [ 1, [ '', [ { type: 'mwReference', attributes: { mainRefKey: 'literal/book', mainListKey: 0, listGroup: 'mwReference/', listKey: 'auto/1', listIndex: 2, refGroup: '', contentsUsed: false }, originalDomElementsHash: 0.6307332933964714 }, { type: '/mwReference' } ] ], 41 ] ) );
		},
	fromDataBody:
