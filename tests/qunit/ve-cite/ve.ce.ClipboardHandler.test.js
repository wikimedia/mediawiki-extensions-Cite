...
QUnit.test.each( 'beforePaste/afterPaste', {
	'Legacy parser read mode references stripped': {
		documentHtml: '<p></p>',
	...
	'Parsoid read mode references stripped': {
		documentHtml: '<p></p>',
		rangeOrSelection: new ve.Range( 1 ),
		pasteHtml: ve.dm.example.singleLine`
		a
	...
	'VE external reference with conflicting name disambiguated': {
		// ref with name foo
	...
	'VE internal reference with same name deduplicated': {
		// ref with name foo
		documentHtml: ve.dm.example.singleLine`
		<p>
			a
	...
	'VE internal sub-reference with same name deduplicated': {
	...
	'VE external sub-reference with conflicting name disambiguated': {
		// ref with name book
		documentHtml: ve.dm.example.singleLine`
		<p>
			a
	...
	'VE external reference with conflicting sub-reference name disambiguated': {
		// sub-ref with name book
		documentHtml: ve.dm.example.singleLine`
		<p>
			a
