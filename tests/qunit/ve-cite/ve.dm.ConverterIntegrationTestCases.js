...
ve.dm.ConverterIntegrationTestCases.cases[ 'Moving main content from subref ( move synth main to other subref )' ] = {
	data: ve.dm.ConverterIntegrationTestCases.movingMainContentFromSub.data,
	body: ve.dm.ConverterIntegrationTestCases.movingMainContentFromSub.body,
	modify:
	( model ) => {
...
ve.dm.ConverterIntegrationTestCases.cases[ 'Moving main content from subref ( move synth main to other ref )' ] = {
	data: ve.dm.ConverterIntegrationTestCases.movingMainContentFromSub.data,
	body: ve.dm.ConverterIntegrationTestCases.movingMainContentFromSub.body,
	modify:
		( model ) => {
